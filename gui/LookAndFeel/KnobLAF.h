...
public:
    KnobLAF(juce::Colour color = juce::Colour::fromRGB(50, 255, 205)) : knobColour(color),
        questrialFont12(*HamburgerFonts::getFontLAF()->questrialFont12),
        questrialFont14(*HamburgerFonts::getFontLAF()->questrialFont14),
        questrialFont16(*HamburgerFonts::getFontLAF()->questrialFont16)
    {
...
private:
    ...
    const Font &questrialFont12;
    const Font &questrialFont14;
    const Font &questrialFont16;
};