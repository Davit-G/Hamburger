# thanks unplugred <3 https://github.com/unplugred/vsts/blob/main/Setup/productbuild.py
def execute():
    import sys
...
<installer-gui-script minSpecVersion="1">
    ...
    <choice id="'''+e['id']+'" title="'+e['name']+'" description="'+e['description']+'''">
        <pkg-ref id="com.aviaryaudio.'''+pluginname.replace(" ","")+version_tag+'-'+e['id']+'">'+pluginname.replace(" ","")+version_tag+'-'+e['id']+'''.pkg</pkg-ref>
    </choice>''')
    file.write('''
