...
#include "../shared/chowdsp_utils/chowdsp_IIRFilter.h"
...
public:
    ...
    void calcCoefs (float fc)
    {
        ...
        float wc = juce::MathConstants<float>::twoPi * fc / fs;
        float c = 1.0f / juce::dsp::FastMathApproximations::tan (wc / 2.0f);
        float phi = c * c;
