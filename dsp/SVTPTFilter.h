...
public:
    ...
    */
    ...
    std::array<SampleType, 3> processSample (int channel, SampleType inputValue);

    inline SampleType processSamplePeakFilter (int channel, SampleType inputValue, SampleType peakGain);
